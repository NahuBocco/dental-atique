    ...
    <footer className="bg-text text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-4">
              ...
              />
              <span className="text-xl font-bold text-white">{clinica.nombre}</span>
            </Link>
            <p className="text-gray-300 mb-4 max-w-md">
              Tu clínica dental de confianza en {clinica.zona}. Cuidamos tu sonrisa con
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/turnos" className="text-gray-300 hover:text-white transition-colors">
                  Turnos Online
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-300">{clinica.direccion}</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href={`tel:${clinica.telefono.replace(/\s/g, '')}`} className="text-gray-300 hover:text-white transition-colors">
                  {clinica.telefono}
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} {clinica.nombre}. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
